  ...
  items={[
    {
      ...
      href: "https://tldr.sh/",
      description:
        "查找命令用法时常用的做法是使用 man，但 man 给出的手册太长了，使用者很难找到自己想要的那部分信息。tldr 以简洁的方式提供某个命令最常用的用法。比如想要查看 disown 的用法: `tldr disown` 即可",
      icon: EllipsisHorizontalCircleIcon,
    },
    {
      title: "z",
      href: "https://github.com/rupa/z",
      description: "z 会收集你最常 cd 的目录，并在你给出一个模糊的字符串或者正则时实现快速跳转",
      icon: EllipsisHorizontalCircleIcon,
    },
    {
      title: "loc",
      href: "https://github.com/cgag/loc",
      description: "分析目录下的代码文件并给出 Lines of Code 信息（默认是分类显示，在计算 LOC 时会考虑空行和注释行）",
      icon: EllipsisHorizontalCircleIcon,
    },
    {
      title: "apt",
